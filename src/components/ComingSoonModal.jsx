...
function ComingSoonModal({ show, onClose }) {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      {/* Retaining 'app-screen' class from the working version for safety */}
      <div className="app-screen modal-content" onClick={(e) => e.stopPropagation()}>
        <div className="rainbow-header">
          <h2>
            <span className="rainbow-left"> 🌈 </span> More Fun Coming Soon! <span className="rainbow-right"> 🌈 </span>
          </h2>
        </div>
        ...
        <div className="coming-soon-message">
          <p>
            {' '}
            ✨ Keep using the app and be surprised for newly added learning materials in a few weeks!
            <br />✨{' '}
          </p>
        </div>

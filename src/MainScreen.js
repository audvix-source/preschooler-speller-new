...
function MainScreen(props) {
  ...
  const handleToucanClick = () => {
    ...
    setGuideVoice('male');
    setTimeout(() => {
      const text = "Hello, I'm Treb, the toucan; great to see you here! Just click the car button below and i'll show you around!";
      speak(text, 'male');
    }, 300);
  };
  ...
  const handleParrotClick = () => {
    ...
    setTimeout(() => {
      const text = "Hi, I'm Maya, the parrot. how are you? Want me to assist you here? Just click on the doll button below me!";
      speak(text, 'female');
    }, 300);
  };
